...
class Site1Assertions() {
    ...
    fun assertIsRawPost1(post: RawPost) {
        assertThat(post.uid).isEqualTo("$SITE_1.1")
        ...
        assertThat(post.ownerUserUid).isEqualTo("$SITE_1.2")
    ...
    fun assertIsRawPost2(post: RawPost) {
        assertThat(post.uid).isEqualTo("$SITE_1.2")
        assertThat(post.postTypeId).isEqualTo("1")
    ...
    fun assertIsRawPost3(post: RawPost) {
        assertThat(post.uid).isEqualTo("$SITE_1.3")
        ...
        assertThat(post.parentUid).isEqualTo("$SITE_1.1")
        assertThat(post.favoriteCount).isNull()
    ...
    fun assertHasComment1(rawComments: List<RawComment>) {
        ...
        assertThat(comment.uid).isEqualTo("$SITE_1.1")
        assertThat(comment.postUid).isEqualTo("$SITE_1.3")
    ...
    fun assertHasComment2(rawComments: List<RawComment>) {
        ...
        assertThat(comment.userUid).isEqualTo("$SITE_1.1")
    }

    fun assertHasComment3(rawComments: List<RawComment>) {
        var comment = getCommentWithUid(rawComments, "$SITE_1.3")
        assertThat(comment.uid).isEqualTo("$SITE_1.3")
        assertThat(comment.postUid).isEqualTo("$SITE_1.2")
        ...
        assertThat(comment.userUid).isEqualTo("$SITE_1.3")
    }

    fun assertHasComment4(rawComments: List<RawComment>) {
        var comment = getCommentWithUid(rawComments, "$SITE_1.4")
        assertThat(comment.uid).isEqualTo("$SITE_1.4")
        assertThat(comment.postUid).isEqualTo("$SITE_1.1")
        assertThat(comment.score).isEqualTo("0")
    ...
    fun assertHasComment6(rawComments: List<RawComment>) {
        ...
        assertThat(comment.uid).isEqualTo("$SITE_1.6")
        assertThat(comment.postUid).isEqualTo("$SITE_1.1")
        assertThat(comment.score).isEqualTo("0")
    ...
    fun assertHasComment9(rawComments: List<RawComment>) {
        ...
        assertThat(comment.uid).isEqualTo("$SITE_1.9")
        assertThat(comment.postUid).isEqualTo("$SITE_1.1")
        assertThat(comment.score).isEqualTo("0")
    ...
    fun assertUser1(user: User) {
        assertThat(user.uid).isEqualTo("$SITE_1.1")
    ...
    fun assertUser2(user: User) {
        assertThat(user.uid).isEqualTo("$SITE_1.2")
    ...
    fun assertUser3(user: User) {
        assertThat(user.uid).isEqualTo("$SITE_1.3")
    ...
    fun assertUser4(user: User) {
        assertThat(user.uid).isEqualTo("$SITE_1.4")
        assertThat(user.reputation).isEqualTo("101")
    ...
    fun assertUser5(user: User) {
        assertThat(user.uid).isEqualTo("$SITE_1.5")
    ...
    fun assertUser6(user: User) {
        assertThat(user.uid).isEqualTo("$SITE_1.6")
