...
class Site2Assertions() {
    /////////////////////////////////////////////////////////////////////////////
    //QUESTIONS
    /////////////////////////////////////////////////////////////////////////////

    fun assertHasQuestion1(questions: Collection<Question>){
        val question = getQuestionByUid("$SITE_2.1", questions)
    ...
    fun assertHasRawPost1(posts: List<RawPost>) {
        var post = getPostWithUid(posts, "$SITE_2.1")
    ...
    fun assertIsRawPost1(post: RawPost) {
        assertThat(post.uid).isEqualTo("$SITE_2.1")
        ...
        assertThat(post.ownerUserUid).isEqualTo("$SITE_2.1")
    ...
    fun assertHasPost2(posts: List<Post>) {
        var post = getPostWithUid(posts, "$SITE_2.2")
        assertIsPost2(post)
    }
    ...
    fun assertIsRawPost2(post: RawPost) {
        assertThat(post.uid).isEqualTo("$SITE_2.2")
        assertThat(post.postTypeId).isEqualTo("2")
        assertThat(post.parentUid).isEqualTo("$SITE_2.1")
    ...
    fun assertHasRawPost3(posts: List<RawPost>) {
        var post = getPostWithUid(posts, "$SITE_2.3")
    ...
    fun assertIsRawPost3(post: RawPost) {
        assertThat(post.uid).isEqualTo("$SITE_2.3")
        assertThat(post.postTypeId).isEqualTo("1")
    ...
    fun assertHasComment1(rawComments: List<RawComment>) {
        var comment = getCommentWithUid(rawComments, "$SITE_2.1")
        assertThat(comment.uid).isEqualTo("$SITE_2.1")
        assertThat(comment.postUid).isEqualTo("$SITE_2.1")
        ...
        assertThat(comment.userUid).isEqualTo("$SITE_2.1")
    }

    fun assertHasComment2(rawComments: List<RawComment>) {
        var comment = getCommentWithUid(rawComments, "$SITE_2.2")
        assertThat(comment.uid).isEqualTo("$SITE_2.2")
        assertThat(comment.postUid).isEqualTo("$SITE_2.1")
        ...
        assertThat(comment.userUid).isEqualTo("$SITE_2.2")
    }

    fun assertHasComment3(rawComments: List<RawComment>) {
        var comment = getCommentWithUid(rawComments, "$SITE_2.3")
        assertThat(comment.uid).isEqualTo("$SITE_2.3")
        assertThat(comment.postUid).isEqualTo("$SITE_2.2")
        ...
        assertThat(comment.userUid).isEqualTo("$SITE_2.3")
    }
    ...
    fun assertHasUser1(users: List<User>) {
        assertUser1(getUserWithUid(users, "$SITE_2.1"))
    }

    fun assertUser1(user: User) {
        assertThat(user.uid).isEqualTo("$SITE_2.1")
    ...
    fun assertHasUser2(users: List<User>) {
        assertUser2(getUserWithUid(users, "$SITE_2.2"))
    }

    fun assertUser2(user: User) {
        assertThat(user.uid).isEqualTo("$SITE_2.2")
    ...
    fun assertHasUser3(users: List<User>) {
        assertUser3(getUserWithUid(users, "$SITE_2.3"))
    }

    fun assertUser3(user: User) {
        assertThat(user.uid).isEqualTo("$SITE_2.3")
